"""owens_duckdb_library.py - Project script (example).
...
def main() -> None:
    ...
    try:
        ...
        # ----------------------------------------------------
        run_sql_script(con, SQL_DIR / "owens_library_clean.sql")

        # ----------------------------------------------------
        # STEP 2: BOOTSTRAP (create tables, load CSV data)
        # ----------------------------------------------------
        run_sql_script(con, SQL_DIR / "owens_library_bootstrap.sql")
